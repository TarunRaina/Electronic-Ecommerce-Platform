      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:tarunraina.691@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                tarunraina.691@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +91 7780886220</Typography>
            <Typography variant="body2" sx={{ marginTop: '0.5rem' }}>
              Address: Kamban Hostel - KEC Campus, TN - 638060
            </Typography>
          </Grid>
        </Grid>
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()} CSE-D Electronics. All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
